...
class JoyController(Node):
    ...
    def forward(self):
        cmd_lf = -self.axis0*self.sf + -self.axis1*self.sf + -self.axis2*self.sf + -self.axis3*self.sf
        # cmd_rf = 
        # cmd_la = 
        # cmd_ra = 
        return None
    ...
    def backward(self):
        cmd = self.axis0*self.sf + self.axis1*self.sf + self.axis2*self.sf + self.axis3*self.sf
        return cmd
