...
goal = [-33.7226643,150.673947,0]  #-33.7226643  , 150.673947
...
class PDController(Node):
    ...
    def update(self,*args): # ex, ey ,eyaw ,yawdot 
        ...
        self.esum += (self.errormat*self.dt)
        ...
        self.f_local = self.kp_mat@self.errormat + self.kd_mat@self.error_rate + 400*np.exp(-self.errormat)*self.esum
        # 
...
# yawmsg = Float64(self.yaw)
        ...
        self.eyaw = self.goalyaw - self.yaw 
